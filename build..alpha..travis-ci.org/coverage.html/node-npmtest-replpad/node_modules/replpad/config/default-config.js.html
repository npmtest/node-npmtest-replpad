...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-replpad/node_modules/replpad/config/default-config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-replpad/node_modules/replpad/config/default-config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-replpad/node_modules/replpad/config/</a> &#187; default-config.js</div>
</div>
<div class="body">
...
/**
  ...
  */
exports.map = <span class="fstat-no" title="function not covered" >function (nmap, imap) {</span>
&nbsp;
  // map 'jk' to 'esc' to switch to normal mode
<span class="cstat-no" title="statement not covered" >  imap('jk', 'esc');</span>
&nbsp;
  // navigate backward in history  via 'ctrl-k' in insert mode
<span class="cstat-no" title="statement not covered" >  imap('ctrl-k', 'ctrl-p');</span>
&nbsp;
};
&nbsp;
/**
